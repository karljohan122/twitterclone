defmodule Twitterclone.TimelineTest do
  ...
  describe "posts" do
    ...
    @invalid_attrs %{body: nil, username: nil, likes_count: nil, replies_count: nil}
    ...
    test "update_post/2 with valid data updates the post" do
      post = post_fixture()
      update_attrs = %{body: "some updated body", username: "some updated username", likes_count: 43, replies_count: 43}
